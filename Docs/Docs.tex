...
\begin{document}
%   \section{Stabilisateur subaquatique pour caméra}
%   
%     Idée: 
%     avoir un système de stabilisation pour caméra permettant de filmer correctement sous l'eau. Un accéléromètre permet de détecter les mouvements de la caméra compensés par deux moteurs perpendiculaires (un pour l'axe vertical, l'autre pour la rotation). Une bouée permet à l'ensemble d'avoir une orientation verticale permanente. \\
%     
%     Pièces:
%     \begin{itemize}
%       \item[\checkmark] 1 Accéléromètre
%       \item[\checkmark] 2 moteurs et leur controlleur (fan 12V de PC + LM317t)
%       \item batterie
%       \item[\checkmark] 1 interrupteur on/off
%       \item[\checkmark] 1 pushbutton pour mettre à jour la position à garder
%       \item arduino      
%     \end{itemize}
%     
%     À faire:
%     \begin{itemize}
%       \item Dessiner le système
%       \item Tester si l'ensemble va sous l'eau
%       \item Faire le code arduino
%     \end{itemize}
%     
%     Code arduino: à l'allumage, stocker les données de l'accéléromètre comme référence, puis détecter les variations et actionner les moteurs en conséquence. Lorsque le pushbutton est activé, mettre à jour la référence.
